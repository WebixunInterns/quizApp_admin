                            ...
                            <div class="card-body rounded">
                                ...
                                <form class="forms-sample" action="addCourse" method="POST">
                                    ...
                                    <div class="form-group row mt-4">
                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label"><h5>Course Name </h5>
                                            </label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="exampleInputUsername2" name="course_name"
                                    ...
                                    <div class="form-group row">
                                        <label for="exampleInputMobile"
                                            class="col-sm-3 col-form-label mt-3"><h5>College Id</h5></label>
                                        <div class="col-sm-9">
