                    ...
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body rounded">
                                ...
                                <form action="admin-addCollege" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label mt-3"><h5>College Name</h5></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control mt-3" id="exampleInputUsername2" name="college_name"
