            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex align-items-center justify-content-end">
                        <a href="{{url("getQuestion")}}" aria-expanded="false">
                            <button type="button" class="btn btn-primary me-2 " id="openModalBtn">Add
                                SubjectQuestion</button>
                        </a>
                    </div>
                    <div class="col-md-2 d-flex align-items-center justify-content-end">
                        <a href="{{url("getAnswer")}}" aria-expanded="false">
                            <button type="button" class="btn btn-primary me-2 " id="openModalBtn">Add
                                SubjectAnswer</button>
                        </a>
                    </div>
                </div>
                <div class="row">
