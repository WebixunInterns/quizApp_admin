                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card overflow-hidden">
                            <div class="card-body1 p-4 rounded">
                                <h2 class="card-title mb-9 fw-semibold">Total Students Registered <br> <br></h2>
                                    <a href="{{url("totalStudent")}}">*</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card overflow-hidden">
                            <div class="card-body1 p-4 rounded">
                                <h2 class="card-title mb-9 fw-semibold">Maximum Number Of Students Enrolled In A Quiz
                                </h2>
                    ...
                    <div class="col-md-4">
                        <div class="card overflow-hidden">
                            <div class="card-body1 p-4 rounded">
                                <h2 class="card-title mb-9 fw-semibold">Active/Inactive Students <br> <br></h2>
