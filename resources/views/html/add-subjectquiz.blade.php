      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body rounded mt-5">
            ...
            <form class="forms-sample" action="admin-addSubjectQuiz" method="POST">
              @csrf
              ...
              <div class="form-group row">
                <label for="exampleInputUsername2" class="col-sm-3 col-form-label mt-3">
                  <h5>SubjectQuiz Name</h5></label>
                <div class="col-sm-9">
                  <input type="text" class="form-control mt-3" id="exampleInputUsername2"  name="quiz_name" placeholder="SubjectName" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="exampleInputConfirmPassword2" class=" col-sm-3 col-form-label mt-3"><h5>Subject Id</h5></label>
                <div class="col-sm-9">
                  <input type="number" class="form-control mt-3" id="exampleInputConfirmPassword2" name="subject_id"
                    placeholder="subject_id" required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-10">
