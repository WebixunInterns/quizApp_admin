      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body rounded mt-5">
            ...
            <form class="forms-sample" action="admin-addSubject" method="POST">
              @csrf
              ...
              <div class="form-group row">
                <label for="exampleInputUsername2" class="col-sm-3 col-form-label mt-3">
                  <h5>Subject Name</h5></label>
                <div class="col-sm-9">
                  <input type="text" class="form-control mt-3" id="exampleInputUsername2"  name="subject_name" placeholder="SubjectName" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="exampleInputConfirmPassword2" class=" col-sm-3 col-form-label mt-3"><h5>Course Id</h5></label>
                <div class="col-sm-9">
                  <input type="number" class="form-control mt-3" id="exampleInputConfirmPassword2" name="course_id"
